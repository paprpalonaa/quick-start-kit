...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-skyBlue/10 via-mintGreen/10 to-babyPink/10 backdrop-blur-sm">
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative p-6 rounded-lg backdrop-blur-md bg-white/30 border border-white/20 
        ...
        <div className="bg-white/30 backdrop-blur-md rounded-lg p-8 border border-white/20">
